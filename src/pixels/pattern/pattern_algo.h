...
#define X(preset_id, token_name, display_name, caps_bitmask, algo_id, dynamic_base) algo_id,
...
inline constexpr size_t pattern_algo_count() noexcept {
  size_t n = 0;
#define X(preset_id, token_name, display_name, caps_bitmask, algo_id, dynamic_base) ++n;
#include "pixels/pattern/pattern_defs.inc"
#undef X
  return n;
}
